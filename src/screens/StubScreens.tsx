...
const styles = StyleSheet.create({
  ...
  statV: { fontFamily: fonts.serif, color: colors.accent, fontSize: 24, fontWeight: '700' },
  statL: { fontFamily: fonts.mono, color: colors.textFaint, fontSize: 9.5, letterSpacing: 0.8, marginTop: 4 },
  proCard: { backgroundColor: colors.surfaceGrad1, borderWidth: 1, borderColor: colors.accent, borderRadius: radius.xl, padding: space(4) },
  proLabel: { fontFamily: fonts.mono, color: colors.accent, fontSize: 11, fontWeight: '700', letterSpacing: 1 },
