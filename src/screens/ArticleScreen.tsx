...
const styles = StyleSheet.create({
  ...
  lead: { fontFamily: fonts.serif, color: colors.text, fontSize: 18, lineHeight: 27, fontWeight: '400', marginBottom: space(4) },
  body: { color: colors.textDim, fontSize: 15, lineHeight: 24, marginBottom: space(4) },
  ...
  pull: { borderLeftWidth: 2, borderLeftColor: colors.live, paddingLeft: 14, marginBottom: space(4) },
  pullText: { fontFamily: fonts.serif, color: colors.text, fontSize: 19, fontWeight: '700', fontStyle: 'italic', lineHeight: 26, letterSpacing: -0.3 },
