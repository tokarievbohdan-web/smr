...
export const DISCUSSIONS: Discussion[] = [
  {
    ...
    hot: true,
    avatars: ['ОК', 'АМ', 'ІС'],
    author: 'Данило Бондар',
    authorRole: 'Sponsorship Manager · betting-платформа',
    authorInitials: 'ДБ',
    body:
      'iGaming-бренди готові платити найбільше за титульні та джерсі-розміщення. Але репутаційні ризики й регуляторний тиск ростуть. Де для українських клубів проходить розумна межа — і як пакувати такі угоди, щоб не втратити частину аудиторії?',
    thread: [
      { author: 'Ірина Савченко', role: 'Commercial Director · федерація', initials: 'ІС', text: 'Ключове — прозорі правила відповідальної гри в самій активації. Тоді категорія працює вдовгу.', helpful: 14 },
      { author: 'Андрій Мельник', role: 'CMO · спортивна платформа', initials: 'АМ', text: 'Ми розділяємо інвентар: джерсі — так, дитячі програми — ніколи. Це знімає більшість питань.', helpful: 9 },
    ],
  },
  {
    id: 'd2',
    ...
    authorRole: 'Commercial Director · федерація',
    authorInitials: 'ІС',
    body:
      'Порівняння з європейськими угодами некоректне без урахування медіапокриття. Давайте зберемо орієнтири по ринку: за скільки реально продається неймінг арени на 5–10 років і від чого залежить цифра?',
    thread: [
      { author: 'Олена Ковальчук', role: 'Head of Sponsorship · ФК «Динамо»', initials: 'ОК', text: 'Головний множник — це трансляційні хвилини з іменем арени в кадрі, а не місткість.', helpful: 11 },
    ],
  },
  {
    id: 'd3',
    ...
    author: 'Марія Ткаченко',
    authorRole: 'Спортивний менеджмент',
    authorInitials: 'МТ',
    body:
      'Якщо у спонсора немає прямого e-commerce, як ви доводите ROI пакета? Які метрики реально приймають фінансові директори з боку бренду?',
    thread: [
      { author: 'Андрій Мельник', role: 'CMO · спортивна платформа', initials: 'АМ', text: 'Brand lift + вартість еквівалентного медіа + опитування впізнаваності до/після. Не ідеально, але приймають.', helpful: 8 },
    ],
  },
  {
    id: 'd4',
    ...
    author: 'Андрій Мельник',
    authorRole: 'CMO · спортивна платформа',
    authorInitials: 'АМ',
    body:
      'Подкаст дає довший контакт з аудиторією і природний інвентар для інтеграцій. Пресконференція — разова і майже не монетизується. Хто вже пробував формат?',
    thread: [
      { author: 'Ірина Савченко', role: 'Commercial Director · федерація', initials: 'ІС', text: 'У нас подкаст закрив річний план по одному нативному партнеру. Формат недооцінений.', helpful: 6 },
    ],
  },
];
